...
# batch_size: per_device_train_batch_size * gradient_accumulation_steps * NPROC_PER_NODE = 2 * 8 * 7 = 112
...
swift rlhf \
    ...
    --output_dir ./zsxm_checkpoint/nips/3_rft/qwen2.5-vl-7b_0415_full_VAL_2_v0#sft#full_bs112_temp1.1 \
