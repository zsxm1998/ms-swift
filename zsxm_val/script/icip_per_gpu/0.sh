...
bash zsxm_val/script/icip_eval/00_cvpr_mvi.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/01_mvi_nuclei.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/03_MoNuSeg.sh "${ARGS[@]}"