...
bash zsxm_val/script/icip_eval/07_TCGA_Uniform_Tumor_cls.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/09_ESCA.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/11_XiaJiabinWeiAi.sh "${ARGS[@]}"
