...
RES_FILE="$LOG_DIR/12_HCC_grading.log"
mkdir -p $LOG_DIR

QUESTION_FILE=datasets/HCC_grading/patch_question_test.jsonl
IMAGE_FOLDER=datasets/HCC_grading/patch_grading
ANSWER_FILE="$LOG_DIR/z12_HCC_grading.jsonl"
