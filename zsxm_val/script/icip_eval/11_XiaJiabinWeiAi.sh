...
RES_FILE="$LOG_DIR/11_XiaJiabinWeiAi.log"
mkdir -p $LOG_DIR

QUESTION_FILE=datasets/XiaJiabinWeiAi/patch_question_test.jsonl
IMAGE_FOLDER=datasets/XiaJiabinWeiAi/patches
ANSWER_FILE="$LOG_DIR/z11_XiaJiabinWeiAi.jsonl"
...
python zsxm_val/code/eval_path_cv/choice_eval.py \
    --gt $QUESTION_FILE \
    --pred $ANSWER_FILE \
    --dataset "XiaJiabin" >> "$RES_FILE" 2>&1
