...
bash zsxm_val/script/icip_eval/02_vessel_det.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/06_NuInsSeg_organ_cls.sh "${ARGS[@]}"
bash zsxm_val/script/icip_eval/08_CRC-MSI.sh "${ARGS[@]}"
