...
RES_FILE="$LOG_DIR/07_TCGA_Uniform_Tumor.log"
mkdir -p $LOG_DIR

QUESTION_FILE=datasets/TCGA_Uniform_Tumor_subset/question_test.jsonl
IMAGE_FOLDER=datasets/TCGA_Uniform_Tumor_subset
ANSWER_FILE="$LOG_DIR/z07_TCGA_Uniform_Tumor.jsonl"
